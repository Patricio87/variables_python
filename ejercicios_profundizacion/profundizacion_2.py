...
print("Ahora, su altura:")

altura = float(input())


print("Su nombre completo es",nombre,apellido, "y su D.N.I es:", documento,)

print("Su nombre completo es", nombre,apellido, "; su edad es de", edad, "años y su altura es", altura, "mts.")